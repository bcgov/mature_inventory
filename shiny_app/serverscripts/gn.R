...
output$mature_tables1 <- renderUI({
...
output$mature_tables2 <- renderUI({
...
#<p>* To match each ground samples with a TSR Predicted Yield Table, a spatial overlay of the ground sample GPS locations and&nbsp;<a href="https://catalogue.data.gov.bc.ca/dataset/vri-2024-forest-vegetation-composite-rank-1-layer-r1-" target="_blank">VRI</a>&nbsp;was completed.</p>
...
<p><strong>Overview</strong></p>
<ul>
<li>The Forest Analysis and Inventory Branch (FAIB) website contains a <a href="https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-inventory/ground-sample-inventories" target="_blank">General Overview of FAIB Ground Sample Inventories</a>.</li>
<li>There are several layers of ground sample data quality assurance including&nbsp;<a href="https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-inventory/training-and-qualified-contractors" target="_blank">Certified Crews</a>, detailed&nbsp;<a href="https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-inventory/ground-sample-inventories/provincial-monitoring/standards" target="_blank">Ground Sampling Procedures</a>, electronic data loggers with hundreds of validation rules to reduce errors and omissions, detailed ground sampling quality assurance procedures (including a 10% random field audit), and a scripted ground sample&nbsp;<a href="https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-inventory/ground-sample-inventories/provincial-monitoring/standards" target="_blank">Data Compilation Process</a>.</li>
<li>The BC Data Catalogue contains several inputs to this reporting including the&nbsp;<a href="https://catalogue.data.gov.bc.ca/dataset/824e684b-4114-4a05-a490-aa56332b57f4" target="_blank">Ground Sample Data Download</a>&nbsp;outputs from the&nbsp;<a href="https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-inventory/ground-sample-inventories/provincial-monitoring/standards" target="_blank">Data Compilation Process</a>.</li>
<li>To match each ground samples with a TSR Predicted Yield Table, a spatial overlay of the ground sample GPS locations and&nbsp;<a href="https://catalogue.data.gov.bc.ca/dataset/vri-2024-forest-vegetation-composite-rank-1-layer-r1-" target="_blank">VRI</a>&nbsp;was completed.</li>
<li>Weighted analysis (using the weighted bootstrap method) was applied to the PHASE2 where possible to those management units with different sub-unit sampling intensities. More information on the TSA specific PHASE2 sample designs and their sampling weights can be found in the Past assessment / Reference section.</li>
<li>All reported net merchantable volumes are at 12.5cm close utilization for PL, 17.5cm for other species, and include all species (deciduous + conifer).</li>
</ul>

<p><strong>Ground vs. inventory</strong></p>
<ul>
<li>Stand table &amp; species composition histograms are computed as pooled (weighted) averages of all mature samples combined for a given reporting strata (TSA, BEC Zone, etc.).</li>
<li>Ground total age and height are from suitable site trees in 0.01ha subplots of each sample, while compiled ground sample net merchantable volume is NVAF-adjusted.</li>
<li>Ratio of means tests are computed for age, height, basal area and volume, with 95% confidence limits around the computed ratio.</li>
</ul>

<p><strong>Comparison with TSR</strong></p>
<ul>
<li>TSR TIPSY Opening Specific and TSR TIPSY Aggregate yield table estimates are based on&nbsp;<a href="https://bcgov.github.io/FAIB_MSYT_overview/" target="_blank">FAIB MSYTs</a>&nbsp;ver. 4. Where&nbsp;<a href="https://bcgov.github.io/FAIB_MSYT_overview/" target="_blank">FAIB MSYTs</a>&nbsp;are not available for a sample location, TSR VDYP existing natural stand yield table estimates are generated by running&nbsp;<a href="https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-inventory/growth-and-yield-modelling/variable-density-yield-projection-vdyp" target="_blank">VDYP7</a>&nbsp;batch console using the published VRI VDYP Input&nbsp;<a href="https://catalogue.data.gov.bc.ca/dataset/57513aaa-c0a6-41a9-b2a8-b980b1604ee6" target="_blank">poly</a>&nbsp;and&nbsp;<a href="https://catalogue.data.gov.bc.ca/dataset/5aedccb7-e4b5-447d-8e38-9a2e5474f9db" target="_blank">layer</a>&nbsp;files.</li>
<li>Note that in strata with TIPSY yield curves, the average TSR yield curve may have an adjustment at age 120.&nbsp; This adjustment is because TIPSY yield curves are only projected to age 120 years while VDYP yield curves are projected to 250 years.&nbsp;&nbsp;</li>
</ul>

<p><strong>Standards of Data Collection</strong></p>
<ul>
<li>Learn more about photo VRI standards <a href="https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-inventory/forest-cover-inventories" target="_blank">here</a>.</li>
</ul>

<p><strong>Forest Health</strong></p>
<ul>
<li>Components of change are computed from individual tree changes (ie., survivor, ingrowth, mortality) between the last two measurements only. Trees initially tagged as subplot trees (4-9 cm DBH) and subsequently as main plot trees (&gt;9 cm DBH) have their "per-hectare-factors" (PHF) fixed relative to the first measurement.</li>
<li>Forest health incidence histograms are computed as pooled (weighted) averages, together with 95% confidence intervals computed using the ""variance of a ratio estimator". Current incidence summaries for a given damage agent are based on all possible occurrences recorded for a given tree, which can be up to 5 damage agents per tree. Therefore, current incidence of all damage agents can together add up to more than 100%. Conversely, when summarizing change in forest health incidence over time, only the primary damage agent is included; therefore, the total change in average incidence will add up to 100%.</li>
</ul>

<p><strong>Comparison with VDYP</strong></p>
<ul>
<li>The VRI earliest_nonlogging_dist_type and harvest_date attributes are used to identify the areas affected by disturbance between measurements.&nbsp;</li>
<li>Learn more about VDYP <a href="https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/forest-inventory/growth-and-yield-modelling/variable-density-yield-projection-vdyp" target="_blank">here</a>.</li>
</ul>

<p><strong>Components of Bias</strong></p>
<ul>
<li>Components of bias are computed by re-running VDYP7 projections after replacing the inventory input attributes age, height, species composition, basal area and stems/ha with ground-based measurements.</li>
</ul>'
  )
