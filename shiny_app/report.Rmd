...
| **Figure 5. Live whole stem volume by DBH class, including all standing trees >= 4cm DBH at the latest measurement.**
...
| **Figure 8. Components of Bias (total, model, attribute), for Basal Area (left graph) and Volume (right graph), by ground sample design.**
